...
class Admin extends CI_Controller
{
	...
	function home()
	{
		if (!empty($this->session->userdata())) {
			...
			$data['title'] = 'Admin - Saung Biru Tenda';
	...
	function kategori_produk()
	{
		...
		$data['title'] = 'Kategori Produk - Saung Biru Tenda';
	...
	function tambah_kategori_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Kategori Produk - Saung Biru Tenda';
	...
	function produk()
	{
		$data['title'] = 'Produk - Saung Biru Tenda';
	...
	function tambah_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Produk - Saung Biru Tenda';
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function edit_produk()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit - Saung Biru Tenda';
			$data['supp'] = $this->model_app->view_ordering('tb_toko_supplier', 'id_supplier', 'DESC');
			$data['record'] = $this->model_app->view_ordering('tb_toko_kategoriproduk', 'id_kategori_produk', 'DESC');
	...
	function rekening()
	{
		...
		$data['title'] = 'Rekening - Saung Biru Tenda';
	...
	function tambah_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Rekening - Saung Biru Tenda';
	...
	function edit_rekening()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Rekening - Saung Biru Tenda';
	...
	function supplier()
	{
		...
		$data['title'] = 'Supplier - Saung Biru Tenda';
	...
	function tambah_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Supplier - Saung Biru Tenda';
	...
	function edit_supplier()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Supplier - Saung Biru Tenda';
	...
	function konsumen()
	{
		$data['title'] = 'Konsumen - Saung Biru Tenda';
	...
	function edit_konsumen()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Konsumen - Saung Biru Tenda';
	...
	function detail_konsumen()
	{
		...
		$data['title'] = 'Detail Konsumen - Saung Biru Tenda';
	...
	function editnote(){
		if($this->input->post('note')){
			...
			$data = array(
				'dateMarried' => date('Y-m-d', strtotime($this->input->post('dateMarried'))),
			);
		}
	...
	function website()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Identitas Website - Saung Biru Tenda';
	...
	function menu()
	{
		...
		$data['title'] = 'Menu Website - Saung Biru Tenda';
	...
	function tambah_menu()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Menu Website - Saung Biru Tenda';
	...
	function edit_menu()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Menu Website - Saung Biru Tenda';
			$data['record'] = $this->model_menu->menu_utama();
	...
	function logo()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Logo Website - Saung Biru Tenda';
	...
	function slider()
	{
		...
		$data['title'] = 'Slider - Saung Biru Tenda';
	...
	function tambah_slider()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Slider - Saung Biru Tenda';
	...
	function edit_slider()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Slider - Saung Biru Tenda';
	...
	function tema()
	{
		...
		$data['title'] = 'Tema Website - Saung Biru Tenda';
	...
	function halaman()
	{
		...
		$data['title'] = 'Halaman - Saung Biru Tenda';
	...
	function tambah_halaman()
	{
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Halaman Baru - Saung Biru Tenda';
	...
	function edit_halaman()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Ubah Halaman Baru - Saung Biru Tenda';
	...
	function artikel()
	{
		$data['title'] = 'Artikel - Saung Biru Tenda';
	...
	function tambah_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Artikel - Saung Biru Tenda';
	...
	function edit_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Artikel - Saung Biru Tenda';
			$data['tag'] = $this->model_artikel->tag_artikel();
			$data['record'] = $this->model_artikel->kategori_artikel();
	...
	{
		$data['title'] = 'Tag - Saung Biru Tenda';
	...
	function tambah_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Tag - Saung Biru Tenda';
	...
	function edit_tag_artikel()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Tag - Saung Biru Tenda';
	...
	function edit_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Edit Pengguna - Saung Biru Tenda';
	...
	function users()
	{
		$data['title'] = 'Manajemen Pengguna - Saung Biru Tenda';
	...
	function tambah_user()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$data['title'] = 'Tambah Pengguna - Saung Biru Tenda';
	...
	function laporan()
	{
		$data['title'] = 'Laporan Penjualan - Saung Biru Tenda';
	...
	function newsletter()
	{
		...
		$data['title'] = 'Newsletter - Saung Biru Tenda';
	...
	function tambah_newsletter()
	{
		...
		if (isset($_POST['submit'])) {
			...
			$ci->email->from('demo-ecommerce@zamanet.com', "Saung Biru Tenda");
			...
			$data['title'] = 'Kirim News Letter - Saung Biru Tenda';
	...
	function lihat_newsletter()
	{
		...
		$data['title'] = 'Detail Berita - Saung Biru Tenda';
	...
	function subscriber()
	{
		$data['title'] = 'Subscriber - Saung Biru Tenda';
