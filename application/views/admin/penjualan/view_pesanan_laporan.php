        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <a class='float-right btn btn-primary btn-sm' href='<?= base_url('admin/print_pesanan'); ?>' target="_blank">Laporan Masuk</a>
            </div>
            ...
            <div class="card-body">
              ...
              <table id="table1" class="tablepesanlaporan table table-striped" style="width:100%">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= date('d-m-Y', strtotime($row['dateMarried'])); ?></td>
                      <td><?= $row['note']; ?></td>
                      ...
                      <td>
                        <div class='btn-group'>
                          ...
                          <div class='dropdown-menu' style='border:1px solid #cecece;'>
                            ...
                            <a class='dropdown-item' href='<?= base_url('admin/pesanan_dikirim/') . $row['id_penjualan'] ?>/3' onclick="return confirm('Apa anda yakin untuk ubah status jadi Close Order ?')"> Close Order</a>
                          </div>
                        </div>
