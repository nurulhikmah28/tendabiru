...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <strong>&copy; <?= date('Y') ?> <a href="http://saungbirutenda.net" target="_BLANK">Saung Biru Tenda</a></strong>
  ...
  <script src="<?= base_url('assets/template/adminlte3/'); ?>plugins/jquery-tabledit-1.2.3/jquery.tabledit.min.js"></script>
  ...
  <script>
    $('.tablepesanlaporan').Tabledit({
        url: site_url + 'admin/editnote',
        editButton: false,
        deleteButton: false,
        hideIdentifier: true,
        columns: {
            identifier: [0, 'id'],
            editable: [[4, 'dateMarried'], [5, 'note']]
        }
    });
  </script>
