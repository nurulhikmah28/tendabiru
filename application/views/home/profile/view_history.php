      ...
      <div class="col-12 col-lg-9 mt-4 mt-lg-0">
        <div class="card">
          ...
          <div class="card-body table-responsive">
            <table id='table1' class='table table-striped table-dark' style="width: 100%">
              <thead>
                <tr>
              ...
              <tbody>
                ...
                foreach ($record as $row) {
                  ...
                  $total = $this->db->query("SELECT a.kode_transaksi, a.proses, sum((b.harga_jual*b.jumlah)) as total FROM `tb_toko_penjualan` a JOIN tb_toko_penjualandetail b ON a.id_penjualan=b.id_penjualan JOIN tb_toko_produk c ON b.id_produk=c.id_produk where a.kode_transaksi='$row[kode_transaksi]'")->row_array();
                  echo "<tr><td>$no</td>
                              ...
                              <td>$fullPayment</td>
                              <td>
                                <a class='btn btn-primary btn-xs' title='Download' href='" . base_url() . "page/download/$row[kode_transaksi]' target='_BLANK'><i class='fa fa-download'></i></a>
                                <a class='btn btn-info btn-xs' title='Rincian data pesanan' href='" . base_url() . "page/tracking_status/$row[kode_transaksi]' target='_BLANK'><i class='fa fa-square'></i></a>
                                <a class='btn btn-info btn-xs' title='Tambah Pembayaran' href='$url' target=$target><i class='fa fa-credit-card'></i></a>
                              </td>
                          </tr>";
                  $no++;
                }
