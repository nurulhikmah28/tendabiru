                                        ...
                                        foreach ($menu->result_array() as $row) {
                                            ...
                                            if ($dropdown == 0) {
                                                if($this->session->level){
                                                    ...
                                                    $menus = $row['nama_menu']=="Konfirmasi Pembayaran" ? "" : $row['nama_menu'];
                                                }
                                        ?>
                                                <li class="nav-links__item">
                                                    <a class="nav-links__item-link" href="<?= base_url() . $row['link']; ?>">
                                                        <div class="nav-links__item-body"><?= $menus; ?></div>
                                                    </a>
                                                </li>
                                            ...
                                            <?php } else { 
                                                    ...
                                                    <a class="nav-links__item-link" href="#">
                                                        <div class="nav-links__item-body"><?= $menus; ?>
                                                    ...
                                                    <?php
                                                        ...
                                                        $menus = $row['nama_menu']=="Pesanan" ? "" : $row['nama_menu'];
                                                    }
                                                ?>
